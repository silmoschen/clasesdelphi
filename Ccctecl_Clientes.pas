unit Ccctecl_Clientes;

interface

uses SysUtils, DB, DBTables, CBDT, CCtactes, CComregi, CListar, CUtiles, CIDBFM, CAdmNumCompr, contenedorMemo, Forms;
...
begin
  ...
  {tabla3.IndexFieldNames := 'Idtitular;Clavecta';
  datosdb.Buscar(tabla3, 'idtitular', 'clavecta', xidtitular, xclavecta);
  tabla3.IndexFieldNames := 'Idtitular;Clavecta;Fecha';
  datosdb.Filtrar(tabla3, 'Idtitular = ' + xidtitular + ' and Clavecta = ' + xclavecta);
  ListarResumenCuenta(xidtitular, xclavecta, iniciar, finalizar, salida);
  tabla3.IndexFieldNames := indice;}
...
begin
  ...
  {tabla3.IndexFieldNames := 'Idtitular;Clavecta';
  datosdb.Buscar(tabla3, 'idtitular', 'clavecta', xidtitular, xclavecta);
  tabla3.IndexFieldNames := 'Idtitular;Clavecta;DC;Fecha';
  datosdb.Filtrar(tabla3, 'Idtitular = ' + xidtitular + ' and Clavecta = ' + xclavecta);
...
begin
  ...
  if cuotasok then Begin
    ...
    enviocartas.Close;
  end else List.Linea(0, 0, 'Sin movimientos', 1, 'Arial, normal, 10', salida, 'S');
end;
