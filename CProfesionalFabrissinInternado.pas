unit CProfesionalFabrissinInternado;
...
// Objetivo...: columnas
begin
  tabla2.FieldByName('nombre').DisplayLabel := 'Nombre'; tabla2.FieldByName('direccion').DisplayLabel := 'Dirección'; tabla2.FieldByName('idprof').DisplayLabel := 'Id.';
  tabla2.FieldByName('telefono').DisplayLabel := 'Teléfono'; tabla2.FieldByName('especial').DisplayLabel := 'Especialidad'; tabla2.FieldByName('matricula').DisplayLabel := 'Matrícula';
...
procedure TTProfesional.Exportar(xcodigo: String);
// Objetivo...: Exportar Datos
var
  tabla1, tabla3: TTable;
begin
  tabla1 := datosdb.openDB('profesio', '', '', dbs.DirSistema + '\export\work');
  tabla3 := datosdb.openDB('profesih', '', '', dbs.DirSistema + '\export\work');
  tabla1.Open; tabla3.Open;
  if Buscar(xcodigo) then Begin
    if tabla1.FindKey([xcodigo]) then tabla1.Edit else tabla1.Append;
    tabla1.FieldByName('idprof').AsString    := tperso.FieldByName('idprof').AsString;
    tabla1.FieldByName('apellido').AsString  := tperso.FieldByName('apellido').AsString;
    tabla1.FieldByName('domicilio').AsString := tperso.FieldByName('domicilio').AsString;
    ...
    tabla3.FieldByName('idprof').AsString    := tabla2.FieldByName('idprof').AsString;
    tabla3.FieldByName('nombre').AsString    := tabla2.FieldByName('nombre').AsString;
    tabla3.FieldByName('direccion').AsString := tabla2.FieldByName('direccion').AsString;
    tabla3.FieldByName('telefono').AsString  := tabla2.FieldByName('telefono').AsString;
    tabla3.FieldByName('especial').AsString  := tabla2.FieldByName('especial').AsString;
    tabla3.FieldByName('matricula').AsString := tabla2.FieldByName('matricula').AsString;
    tabla3.FieldByName('categoria').AsString := tabla2.FieldByName('categoria').AsString;
    tabla3.FieldByName('tipodoc').AsString   := tabla2.FieldByName('tipodoc').AsString;
    tabla3.FieldByName('numdoc').AsString    := tabla2.FieldByName('numdoc').AsString;
    tabla3.FieldByName('email').AsString     := tabla2.FieldByName('email').AsString;
    try
      tabla3.Post
     except
      tabla3.Cancel
...
procedure TTProfesional.Importar(xcodigo: String);
// Objetivo...: Importar Datos
var
  tabla1, tabla3: TTable;
begin
  tabla1 := datosdb.openDB('profesio', '', '', dbs.DirSistema + '\import\estructu');
  tabla3 := datosdb.openDB('profesih', '', '', dbs.DirSistema + '\import\estructu');
  tabla1.Open; tabla3.Open;
  if tabla1.FindKey([xcodigo]) then Begin
    if tperso.FindKey([xcodigo]) then tperso.Edit else tperso.Append;
    tperso.FieldByName('idprof').AsString    := tabla1.FieldByName('idprof').AsString;
    tperso.FieldByName('apellido').AsString  := tabla1.FieldByName('apellido').AsString;
    tperso.FieldByName('domicilio').AsString := tabla1.FieldByName('domicilio').AsString;
    ...
    if tabla3.FindKey([xcodigo]) then Begin
      ...
      tabla2.FieldByName('idprof').AsString    := tabla3.FieldByName('idprof').AsString;
      tabla2.FieldByName('nombre').AsString    := tabla3.FieldByName('nombre').AsString;
      tabla2.FieldByName('direccion').AsString := tabla3.FieldByName('direccion').AsString;
      tabla2.FieldByName('telefono').AsString  := tabla3.FieldByName('telefono').AsString;
      tabla2.FieldByName('especial').AsString  := tabla3.FieldByName('especial').AsString;
      tabla2.FieldByName('matricula').AsString := tabla3.FieldByName('matricula').AsString;
      tabla2.FieldByName('categoria').AsString := tabla3.FieldByName('categoria').AsString;
      tabla2.FieldByName('tipodoc').AsString   := tabla3.FieldByName('tipodoc').AsString;
      tabla2.FieldByName('numdoc').AsString    := tabla3.FieldByName('numdoc').AsString;
      tabla2.FieldByName('email').AsString     := tabla3.FieldByName('email').AsString;
      try
        tabla2.Post
       except
        tabla2.Cancel
