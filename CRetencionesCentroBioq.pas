...
Begin
  ...
  if xsubitems = utiles.sLlenarIzquierda(IntToStr(xcantitems), 2, '0') then begin
    datosdb.tranSQL(DBConexion, 'delete from escalaretenciones where items = ' + '"' + xitems + '"' + ' and subitems > ' + '"' + utiles.sLlenarIzquierda(IntToStr(xcantitems), 2, '0') + '"');
    escala.Close;
    escala.Open;
  end;
end;
