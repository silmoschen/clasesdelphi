...
begin
  ...
  list.Linea(0, 0, ' ', 1, 'Arial, normal, 6', salida, 'S');
  list.Linea(0, 0, 'Créd. Resoluciones Varias : ', 1, 'Arial, normal, 8', salida, 'N');
...
begin
  ...
  // 1º Línea de Títulos
  list.Titulo(0, 0, 'Condición Fiscal',1 , 'Arial, cursiva, 8');
...
begin
  if (salida = 'P') or (salida = 'I') then Begin
    if movim = 'Ventas' then Begin
      ...
      list.linea(127, list.lineactual, 'Percepción' ,9 , 'Arial, cursiva, 8', salida, 'N');
      ...
      list.linea(143, list.lineactual, 'Operación' ,8 , 'Arial, cursiva, 8', salida, 'N');
      list.linea(159, list.lineactual, 'Nº 2784' ,9 , 'Arial, cursiva, 8', salida, 'S');
    end;
    if movim = 'Compras' then Begin
      ...
      list.linea(88,  list.lineactual, 'I.V.A.' ,6 , 'Arial, cursiva, 8', salida, 'N');
      list.linea(101, list.lineactual, 'I.V.A.' ,7 , 'Arial, cursiva, 8', salida, 'N');
      list.linea(111, list.lineactual, 'Créd. p/Res.' ,8 , 'Arial, cursiva, 8', salida, 'N');
      list.linea(127, list.lineactual, 'Percepción' ,9 , 'Arial, cursiva, 8', salida, 'N');
      list.linea(146, list.lineactual, 'Total' ,10 , 'Arial, cursiva, 8', salida, 'N');
...
begin
  ...
  if (salida = 'P') or (salida = 'I') then Begin
    ...
    list.Linea(90, list.lineactual, ' ', 3, 'Courier New, normal, 10', salida, 'S');
    list.Linea(0, 0, 'Retención Combustibles .........: ', 1, 'Courier New, normal, 10', salida, 'N');
