...
uses CPlanctas, SysUtils, CListar, DB, DBTables, CBDT, CUtiles, CIDBFM, CLibCont;
...
begin
  inherited Create;
  cabasmod := datosdb.openDB('cabasmod', 'Codasiento');
  asienmod := datosdb.openDB('asienmod', 'Codasiento;Nromovi');
end;
