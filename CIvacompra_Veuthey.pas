...
begin
  ...
  list.Titulo(0, 0, ' Período', 1, 'Arial, cursiva, 8');
  list.Titulo(20, list.lineactual, 'Comprobante' + utiles.espacios(22) + 'Cliente', 2, 'Arial, cursiva, 8');
  list.Titulo(50, list.lineactual, 'Nro. C.U.I.T. / Razón Social', 3, 'Arial, cursiva, 8');
...
begin
 ...
 if not inf_iniciado then
  ...
  if t_filtro = '7' then Begin
    ...
    if (salida = 'P') or (salida = 'I') then Begin
      list.Linea(0, 0,  '              Categoría de Mov.: ' + tipomovimiento.Codmov + ' - ' + tipomovimiento.Descrip, 1, 'Arial, normal, 10', salida, 'S');
      list.Linea(0, 0,  '', 1, 'Arial, normal, 5', salida, 'S');
    end;
    if salida = 'T' then Begin
      list.LineaTxt('  Categoría de Mov.: ' + tipomovimiento.Codmov + ' - ' + tipomovimiento.Descrip, True);
    end;
  end;
...
Begin
  ...
  excel.setString('F3', 'F3', 'Cód.', 'Arial, normal, 9');
  excel.setString('G3', 'G3', 'Razón Social', 'Arial, normal, 9');
  ...
  excel.setString('U3', 'U3', 'Retención', 'Arial, normal, 9');
