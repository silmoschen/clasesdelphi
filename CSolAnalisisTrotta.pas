...
TTSolicitudAnalisisTrotta = class(TTSolicitudAnalisis)
 public
  ...
  function    getProtocolosItemsResultado(xnrosolicitud, xitems, xlinea: string): TQuery;
...
function TTSolicitudAnalisisTrotta.getProtocolosItemsResultado(xnrosolicitud, xitems, xlinea: string): TQuery;
begin
  result := datosdb.tranSQL('select nrosolicitud, items, codanalisis, resultado, valoresn, nroanalisis from resultado where nrosolicitud = ' + ''''
         + xnrosolicitud + '''' + ' and codanalisis =  ' + '''' + xitems + '''' + ' and nroanalisis = ' + '''' + xlinea + '''' + ' order by items');
end;
