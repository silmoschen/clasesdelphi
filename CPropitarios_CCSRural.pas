...
TTPropietario = class(TTPersona)
 ...
 public
  ...
  function    getPropietariosGastosFijos: TQuery;
...
function TTPropietario.getPropietariosGastosFijos: TQuery;
begin
  result := datosdb.tranSQL('select idpropiet from ' + tabla2.TableName + ' where fijo = ' + '''' + 'S' + '''');
end;
