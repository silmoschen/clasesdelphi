unit CRegContAsociacion;

interface

uses CContabilidadAsociacion, CPlanctasAsociacion, CLibContAsociacion, CPeriodoAsociacion, DBTables, CBDT, CUtiles, CIDBFM, CListar;
...
begin
  inherited Create;
  cabasien  := datosdb.openDB('cabasien', 'Periodo;Nroasien', '', contabilidad.dbcc);
  asientos  := datosdb.openDB('asientos', '', 'Idasiento', '', contabilidad.dbcc);
  ccostos   := datosdb.openDB('ccostos', 'Periodo;Nroasien;Codcta;Nromovi', '', contabilidad.dbcc);
  plansaldo := datosdb.openDB('plansaldo', 'Codcta;Periodo', '', contabilidad.dbcc);
