...
begin
  ...
  List.Titulo(0, 0, 'Cód. Entidad', 1, 'Arial, cursiva, 8');
  List.Titulo(50, list.Lineactual, 'Dirección', 2, 'Arial, cursiva, 8');
...
begin
  if conexiones = 0 then Begin
    ...
    tabla.FieldByName('direccion').DisplayLabel := 'Dirección'; tabla.FieldByName('telefono').DisplayLabel := 'Teléfono';
