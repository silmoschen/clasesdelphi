...
TTLotes = class
 ...
 public
  ...
  function    getCantidadLotesPorcentaje(xidpropiet: string): integer;
 private
...
function  TTLotes.getCantidadLotesPorcentaje(xidpropiet: string): integer;
// Objetivo...: Devolver la Cantidad de Lotes que recolectan residuos
var
  r: TQuery;
  i: integer;
begin
  r := datosdb.tranSQL('select count(*) from lotes where idpropiet = ' + '''' + xidpropiet + '''' + ' and ggporcentaje = 1');
  r.Open;
